...
__DEFINE__(1680526857942, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1680526857943,"./event-store":1680526857944}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1680526857943, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1680526857944, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1680526857943,"./utils":1680526857945}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1680526857945, function(require, module, exports) {
...
return __REQUIRE__(1680526857942);
})()
